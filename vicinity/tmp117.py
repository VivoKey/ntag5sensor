...
TMP117_I2C_SLAVE_ADDRESS =      0x48 # MikroElektronika: 0x48, Temptress: 0x4A, Pulse: 0x49
...
class TMP117:
    ...
    def read_register(self, register):
        while(self.chip.check_i2c_busy()):
            ...
            time.sleep(0.1)
        self.chip.write_i2c(TMP117_I2C_SLAVE_ADDRESS, bytes([register]))
        if(not self.chip.check_i2c_write_result()):
            raise Exception("Register address write was not acknowledged")
        self.chip.read_i2c(TMP117_I2C_SLAVE_ADDRESS, 2)
